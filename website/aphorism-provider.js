fetch('./aphorism.json')
  ...
  .then(data => {
    ...
    aphorismElement.textContent = `"${data.aphorism}"`;
  ...
  .catch(error => {
        ...
        document.querySelector('.aphorism').textContent = "Apologies, but it appears there's been an issue retreiving today's aphorism. If this continues to be an issue, drop Sam a line."
  });